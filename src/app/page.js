...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className={`flex flex-col min-w-screen items-center pt-24 pb-5 px-5 bg-[#fcf6f1]`}>
        ...
        <div>
          <h2 className='text-center mt-[35px] text-[#240B06]'>Mi bautizo</h2>
          ...
          <h3 className='text-center mt-[35px] text-[30px]'>Asistencia</h3>
